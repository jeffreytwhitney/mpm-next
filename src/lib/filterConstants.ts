/**
 * Shared filter and list UI constants used across multiple features.
 * Used by Tasks, Tickets, Service Tickets, and other list-based views.
 */

export const ROW_HIGHLIGHT_OPACITY = 0.5
