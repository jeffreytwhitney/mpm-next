 ...
 * App Router page module for '/tickets/@child/(.)[id]/tasks/[taskId]/notes/new'.
 */
...
interface TicketTaskNoteChildModalPageProps {
  params: Promise<{ id: string; taskId: string }>
}

export default async function TicketTaskNoteChildModalPage({ params }: TicketTaskNoteChildModalPageProps) {
