 ...
 * App Router page module for '/tasks/@child/(..)tickets/[id]/tasks/[taskId]/time-entry'.
 */
...
interface TaskTicketTaskTimeEntryChildModalPageProps {
  params: Promise<{ id: string; taskId: string }>
}

export default async function TaskTicketTaskTimeEntryChildModalPage({
  params,
}: TaskTicketTaskTimeEntryChildModalPageProps) {
