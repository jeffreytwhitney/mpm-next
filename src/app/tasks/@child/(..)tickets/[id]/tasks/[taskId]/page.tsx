 ...
 * App Router page module for '/tasks/@child/(..)tickets/[id]/tasks/[taskId]'.
 */
...
interface TaskTicketTaskDetailChildModalPageProps {
  params: Promise<{ id: string; taskId: string }>
}

export default async function TaskTicketTaskDetailChildModalPage({
  params,
}: TaskTicketTaskDetailChildModalPageProps) {
